...
module Telstra_EventDetection
  ...
  class SubscriptionObj
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'msisdns')
        if (value = attributes[:'msisdns']).is_a?(Array)
          self.msisdns = value
        end
      end

      if attributes.has_key?(:'notificationURL')
        self.notification_url = attributes[:'notificationURL']
      end
    ...
    def list_invalid_properties
      ...
      if @msisdns.nil?
        invalid_properties.push("invalid value for 'msisdns', msisdns cannot be nil.")
      end
    ...
    def hash
      [msisdns, notification_url, event_type].hash
    end
